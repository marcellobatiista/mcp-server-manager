...
def verificar_ambiente():
    ...
    if not os.path.exists("mcp_server") or not os.path.isdir("mcp_server"):
    ...
    venv_path = os.path.join("mcp_server", ".venv")
    if not os.path.exists(venv_path) or not os.path.isdir(venv_path):
        print("Erro: O ambiente virtual não foi encontrado em mcp_server/.venv!")
        print("Execute primeiro o script quick_setup.py para criar o ambiente básico.")
        return False
